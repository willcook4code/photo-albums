...
(0, _jquery2.default)('#marmotIcon6').click(function () {
	...
	(0, _jquery2.default)('.marmotPics').show();
...
(0, _jquery2.default)('.allDogs').click(function (e) {
	...
	(0, _jquery2.default)('#dogsAlbum').show();
});
(0, _jquery2.default)('.allFishes').click(function (e) {
	(0, _jquery2.default)('button').removeClass('active');
	(0, _jquery2.default)(e.target).addClass('active');
	(0, _jquery2.default)('.photoList').hide();
	(0, _jquery2.default)('#fishesAlbum').show();
});
(0, _jquery2.default)('.allSloths').click(function (e) {
	(0, _jquery2.default)('button').removeClass('active');
	(0, _jquery2.default)(e.target).addClass('active');
	(0, _jquery2.default)('.photoList').hide();
	(0, _jquery2.default)('#slothsAlbum').show();
});
(0, _jquery2.default)('.allPigs').click(function (e) {
	(0, _jquery2.default)('button').removeClass('active');
	(0, _jquery2.default)(e.target).addClass('active');
	(0, _jquery2.default)('.photoList').hide();
	(0, _jquery2.default)('#pigsAlbum').show();
});
(0, _jquery2.default)('.allMarmots').click(function (e) {
	(0, _jquery2.default)('button').removeClass('active');
	(0, _jquery2.default)(e.target).addClass('active');
	(0, _jquery2.default)('.photoList').hide();
	(0, _jquery2.default)('#marmotsAlbum').show();
});
(0, _jquery2.default)('.allPenguins').click(function (e) {
	(0, _jquery2.default)('button').removeClass('active');
	(0, _jquery2.default)(e.target).addClass('active');
	(0, _jquery2.default)('.photoList').hide();
	(0, _jquery2.default)('#penguinsAlbum').show();
});
//Top Page to Mid Page~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
(0, _jquery2.default)('.allMarmots').click(function (e) {
	(0, _jquery2.default)('.topPage').hide();
	(0, _jquery2.default)('.midPage').show();
	(0, _jquery2.default)('.allMarmots').addClass('active');
	(0, _jquery2.default)('#marmotsAlbum').show();
});
(0, _jquery2.default)('.allPenguins').click(function (e) {
	(0, _jquery2.default)('.topPage').hide();
	(0, _jquery2.default)('.midPage').show();
	(0, _jquery2.default)('.allPenguins').addClass('active');
	(0, _jquery2.default)('#penguinsAlbum').show();
});
(0, _jquery2.default)('.allPigs').click(function (e) {
	(0, _jquery2.default)('.topPage').hide();
	(0, _jquery2.default)('.midPage').show();
	(0, _jquery2.default)('.allPigs').addClass('active');
	(0, _jquery2.default)('#pigsAlbum').show();
});
(0, _jquery2.default)('.allSloths').click(function (e) {
	(0, _jquery2.default)('.topPage').hide();
	(0, _jquery2.default)('.midPage').show();
	(0, _jquery2.default)('.allSloths').addClass('active');
	(0, _jquery2.default)('#slothsAlbum').show();
});
(0, _jquery2.default)('.allDogs').click(function (e) {
	(0, _jquery2.default)('.topPage').hide();
	(0, _jquery2.default)('.midPage').show();
	(0, _jquery2.default)('.allDogs').addClass('active');
	(0, _jquery2.default)('#dogsAlbum').show();
});
(0, _jquery2.default)('.allFishes').click(function (e) {
	(0, _jquery2.default)('.topPage').hide();
	(0, _jquery2.default)('.midPage').show();
	(0, _jquery2.default)('.allFishes').addClass('active');
	(0, _jquery2.default)('#fishesAlbum').show();
});
